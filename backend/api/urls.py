...
urlpatterns = [
    ...
    path('cart-delete//<int:item_id>/<int:user_id>/', store_views.CartItemDeleteAPIView.as_view()),
    path('cart-delete//<int:item_id>/', store_views.CartItemDeleteAPIView.as_view()),
]