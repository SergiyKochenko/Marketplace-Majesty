        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                <div className="container">
                    <Link className="navbar-brand" to="/">E-Majesty</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><Link className="dropdown-item" to="/vendor/products/"> <i className="fas fa-boxes"></i> Products</Link></li>
                        ...
                        {isLoggedIn()
                            ...
                            <>
                                ...
                                <button onClick={handleLogoutClick} className="btn btn-primary me-2">Logout</button>
                            </>
                            :
                            <>
