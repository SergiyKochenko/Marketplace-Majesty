                        ...
                        <div key={index} className="row text-dark">
                          <div className="col-lg-6 mb-2">
                            ...
                            {item.image && (item.image.preview ? (
                              <img  src={item.image.preview} alt="" style={{width:"100%", height:"200px", objectFit:"cover", borderRadius:"10px"}} />
                            ): (
                              <img  src={item.image} alt="" style={{width:"100%", height:"200px", objectFit:"cover", borderRadius:"10px"}} />
                            ))}
